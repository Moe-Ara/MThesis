...
# Use the custom NN reasoning profile for the demo.
$env:INTEL_MODEL_REGISTRY = "intelligence/models/registry.json"
$env:INTEL_ACTIVE_PROFILE = "custom-nn-reasoning-20260306"
$env:INTEL_MODEL_PROFILE = "custom-nn-reasoning-20260306"
$env:THREAT_SCORER_MODEL_PROFILE = "custom-nn-reasoning-20260306"
$env:PLANNER_MODEL_PROFILE = "custom-nn-reasoning-20260306"
...
$env:INTEL_PLANNER_NN_MODEL_PATH = "intelligence/models/planner_nn_reasoning_20260306"
...
$env:DEMO_TRACE_ONLY_SUCCESS = "true"
$env:DEMO_TRACE_MAX_AUDIT = "50"
$env:REASONING_DATA_DIR = "data/reasoning"

# Persist cases to SQLite for the case dashboard.
$env:CASE_DB_PATH = "data/cases.db"

# Ensure a clean, successful pipeline.
$env:SIMULATOR_ALERT_COUNT = "1"
$env:SIMULATOR_INCLUDE_EDGE_CASES = "false"
$env:SIMULATOR_FORCE_SCENARIO = "LateralMovementPowerShell"
...
$stdout = Join-Path $logDir "intel_custom_nn_reasoning.log"
$stderr = Join-Path $logDir "intel_custom_nn_reasoning.err.log"
